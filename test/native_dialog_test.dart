...
void main() {
  ...
  group('NativeDialog', () {
    const channel = MethodChannel('native_dialog');
    const defaultResponses = <String, dynamic>{'alert': null, 'confirm': true};

    final exception = PlatformException(
        code: 'UNAVAILABLE', message: 'Native alert is unavailable');
    ...
    group('alert', () {
      test('invokes correct method', () async {
        ...
        expect(log, [
          isMethodCall('alert', arguments: ['Oops, something went wrong!'])
        ]);
      });
      ...
      test('fails', () async {
        ...
        expect(NativeDialog.alert('Hoge'),
    ...
    group('confirm', () {
      test('invokes correct method', () async {
        ...
        expect(log, [
          isMethodCall('confirm', arguments: ['Do you really want to leave?'])
        ]);
      });
      ...
      test('confirms', () async {
        ...
        final confirmed = await NativeDialog.confirm('Hoge');
      ...
      test('fails', () async {
        ...
        expect(NativeDialog.confirm('Hoge'),
            throwsA(isInstanceOf<PlatformException>()));
      });
    });
  });
